  ...
  return (
    <div className="bg-[#0d1117] text-white">
      ...
      <div className="flex flex-col lg:flex-row mt-4">
        ...
        <aside
          className="w-full lg:w-1/4 p-6  bg-[#0d1117] 
                         lg:fixed lg:top-20 lg:h-[calc(100vh-5rem)] z-30"
        >
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left mt-28 xl:ml-14 lg:mt-10">
            <img
              ...
              alt="Ahsan Habib"
              className="w-56 h-56 xl:w-60 xl:h-60 lg:w-52 lg:h-52 bg-cover object-cover 2xl:w-80 2xl:h-80 rounded-full items-center border-4 border-yellow-500 mb-4"
            />
            <div className="text-left w-full ml-16 lg:ml-0">
            ...
            <div className="my-4 ml-16 lg:ml-0 text-left w-full text-sm space-y-1">
